...
<body>
    ...
    <br/>
        <?php
            ...
            $sql = "SELECT * FROM admin_prevcom";
            $result = mysqli_query($conn, $sql);

            // Display the fetched worker details
            if (mysqli_num_rows($result) > 0) {
                echo "<table>";
                echo "<tr><th>ID</th><th>Building</th><th>Block</th><th>category</th><th>Description</th><th>Query</th><th>Created_at</th><th>First Name</th><th>Last Name</th><th>Email</th></tr>";
