...
<body>
    ...
    <br/>
    <form method="GET" action="/admin/workerss.php">
    <?php
            session_start();
            ...
            if (mysqli_num_rows($result) > 0) {
                echo "<table>";
                echo "<tr><th>ID</th><th>Building</th><th>Block</th><th>category</th><th>Description</th><th>Query</th><th>Assign</th></tr>";
                while ($row = mysqli_fetch_assoc($result)) {
                    ...
                    echo "<form method='GET' action='/admin/workerss.php'>";
                    echo "<td>". "<button class='assign' name='assign' value='". $row['id']. "' >Assign</button>". "</td>";
                    echo "<input type='hidden' name='value' value='". $row['id']. "'>";
                    echo "</form>";
                    echo "</tr>";
                }
                echo "</table>";
